...
import com.alpokat.kasir.Print.UnicodeFormatter;
...
public class PembayaranBarcodeActivity extends AppCompatActivity implements Runnable {
    ...
    private void autoConnect(){
        ...
        if (mBluetoothAdapter == null) {
            Toast.makeText(PembayaranBarcodeActivity.this, "Message1", Toast.LENGTH_SHORT).show();
        } else {
            if (!mBluetoothAdapter.isEnabled()) {
                ...
                ListPairedDevices();
                Intent i = new Intent(PembayaranBarcodeActivity.this, DeviceListActivity.class);
    ...
    public void onActivityResult(int mRequestCode, int mResultCode,
        ...
        switch (mRequestCode) {
            ...
            case REQUEST_ENABLE_BT:
                if (mResultCode == Activity.RESULT_OK) {
                    ListPairedDevices();
                    Intent connectIntent = new Intent(PembayaranBarcodeActivity.this,
